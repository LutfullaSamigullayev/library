...
const { register, login, toAdmin, verify, logout, forgetPassword, resetPassword } = require("../controller/auth.controller");
...
AuthRouter.post("/forget_password", authValidatorMiddleware("forget"), forgetPassword);
AuthRouter.post("/reset_password", authValidatorMiddleware("reset"), resetPassword);
